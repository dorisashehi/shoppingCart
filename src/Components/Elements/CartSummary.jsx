      ...
      <div className="flex flex-col h-[500px] md:h-[800px] lg:h-[500px] overflow-y-auto">
        <div className="flex gap-x-5 cart-section mb-5">
          ...
          <div className="flex flex-col relative flex-1">
            ...
            <h3 className="cart-header">Women Hat</h3>
            <span className="cart-item font-epilogue">Price: $45</span>
            <span className="cart-item font-epilogue">Quantity: 2</span>
        ...
        <span className="cart-header">Order Total: $45</span>
      </div>
